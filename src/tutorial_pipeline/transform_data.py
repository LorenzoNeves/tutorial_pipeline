...
path_name = Path(__file__).resolve().parent.parent.parent / 'data' / 'weather_data.json'
#igual a '../data/weather_data.json' mas é mais profissional e evita alguns erros

columns_name_to_drop = ['weather', 'weather_icon', 'sys.type']
#dropar weather pq a gnt ja normalizou ela, icon vai ser criada depois da normalização das colunas, sys.type só tira ae
...
#'->' = retornar algo, nesse caso pd.DataFrame
#normalizar as colunas do nosso dataframe
